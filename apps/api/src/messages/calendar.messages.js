...
export const CALENDAR_SHARED = 'Calendar shared successfully'
export const CALENDAR_ACCESS_REMOVED = 'Calendar access removed successfully'
...
export const EVENT_ACCESS_DENIED = 'Access denied to event'
export const ATTENDEE_ADDED = 'Attendee added successfully'
...
export const REMINDER_ACCESS_DENIED = 'Access denied to reminder'
